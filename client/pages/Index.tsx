...
function DarkButton({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <button className={`inline-flex items-center justify-center h-10 px-6 rounded-[13px] btn-dark text-white text-[12px] font-medium transition-all duration-150 active:scale-97 whitespace-nowrap hover:bg-[#3E3E45] ${className}`}>
      {children}
    </button>
  );
}
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white pt-24 pb-16">
      ...
      <div className="relative z-10 w-full max-w-[1536px] mx-auto flex flex-col items-center gap-6 px-6 sm:px-8 lg:px-20 text-center">
        {/* Badge */}
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#E6E6E6] bg-white  shadow-[0_6px_10px_-6px_#00000016] ">
          <span className="gradient-text-rainbow text-[13px] font-medium leading-[18px]">
            Create in under 60 seconds
          </span>
          <span className="flex items-center justify-center w-7 h-7 rounded-full btn-dark-sm flex-shrink-0 active:scale-95 transition-all">
        ...
        {/* Prompt card */}
        <div className="w-full max-w-[1040px] rounded-[13px] glass-card p-4 sm:p-5 flex flex-col gap-5 mt-4">
          <div className="rounded-[13px] border border-[#E6E6E6] bg-white/20 p-5 flex flex-col gap-4  shadow-[0_6px_10px_-6px_#00000016] ">
            {/* Textarea */}
            <textarea
            ...
            <div className="flex items-center justify-between flex-wrap gap-3 pt-2 border-t border-[#F3F3F3]">
              <div className="flex items-center gap-3">
                {/* Add button */}
                <button className="flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#E6E6E6] card-btn-shadow hover:bg-[#F7F7F7] active:scale-95 transition-all">
                ...
                <button className="h-10 px-5 rounded-[13px] bg-[#F3F3F3] text-black text-[12px] font-medium hover:bg-[#EAEAEA] active:scale-97 transition-all whitespace-nowrap">
                  Enhance prompt
                </button>
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="flex items-center justify-center w-9 h-9 rounded-full bg-[#2A2A2F] text-white  shadow-[0_6px_10px_-6px_#00000016]  hover:bg-[#3E3E45] active:scale-95 transition-all">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          ...
          >
            {TEMPLATES_LARGE.map((t, i) => (
              <div key={i} className="flex-shrink-0 w-[300px] sm:w-[380px] lg:w-[495px] template-card group">
                <div className="relative aspect-square rounded-[13px] overflow-hidden bg-[#FBFBFB] border border-[#E6E6E6] p-[11px]  shadow-[0_6px_10px_-6px_#00000016] ">
                  ...
                  <div className="template-hover-overlay absolute inset-[11px] flex items-center justify-center rounded-[8px] bg-white/30 backdrop-blur-[1.5px]">
                    <div className="relative">
                      ...
                      <div className="relative p-0.5 rounded-[13px] overflow-hidden bg-white">
                        <button className="h-10 px-5 rounded-[13px] bg-[#2A2A2F] text-white text-[12px] font-medium hover:bg-[#3E3E45] active:scale-97 transition-all  shadow-[0_6px_10px_-6px_#00000016] ">
                          Customize this look
                        </button>
                      </div>
                    </div>
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center justify-center w-8 h-8 rounded-[13px] border border-[#E6E6E6] bg-white text-black  shadow-[0_6px_10px_-6px_#00000016]  hover:bg-[#F3F3F3] active:scale-95 transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {HOW_IT_WORKS.map((item, i) => (
            <div key={i} className="flex flex-col gap-4">
              <div className="rounded-[13px] border border-[#E6E6E6] bg-white  shadow-[0_6px_10px_-6px_#00000016]  overflow-hidden p-2">
                <img
                  src={item.img}
                  alt={item.boldText}
    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-white border-b border-[#E6E6E6]">
      <div className="max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-20 flex flex-col gap-8">
        ...
        <div className="flex justify-center mt-2">
          <div className="flex items-center rounded-[13px] bg-[#F3F3F3] p-1 border border-[#E6E6E6]  shadow-[0_6px_10px_-6px_#00000016] ">
        ...
        <div className="relative mt-4">
          ...
          >
            {BUSINESS_CARDS.map((src, i) => (
              <div key={i} className="flex-shrink-0 w-full max-w-[900px] sm:max-w-[1100px] rounded-[8px] overflow-hidden  shadow-[0_6px_10px_-6px_#00000016] ">
          ...
          <button
            onClick={() => scrollCarousel("prev")}
            className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center justify-center w-10 h-10 rounded-full bg-white border border-[#E6E6E6] text-black  shadow-[0_6px_10px_-6px_#00000016]  hover:bg-[#F3F3F3] active:scale-95 transition-all hidden sm:flex"
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              <path d="M7.75625 9.30754L4.65375 6.20504L7.75625 3.10254" stroke="currentColor" strokeWidth="1.03417" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          <button
            onClick={() => scrollCarousel("next")}
            className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center w-10 h-10 rounded-full bg-white border border-[#E6E6E6] text-black  shadow-[0_6px_10px_-6px_#00000016]  hover:bg-[#F3F3F3] active:scale-95 transition-all hidden sm:flex"
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              <path d="M4.65375 9.30754L7.75625 6.20504L4.65375 3.10254" stroke="currentColor" strokeWidth="1.03417" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
      ...
      <div className="max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-20">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <div className="w-full max-w-[800px] relative mt-2">
            ...
            <div className="relative p-1 rounded-[13px] overflow-hidden bg-white border border-[#E6E6E6]  shadow-[0_6px_10px_-6px_#00000016] ">
              <div className="flex items-center justify-between px-5 py-4 rounded-[11px] bg-white">
                ...
                <button className="flex items-center justify-center w-8 h-8 rounded-full btn-dark-sm active:scale-95 transition-all text-white  shadow-[0_6px_10px_-6px_#00000016] ">
      ...
      <div className="max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {BRAND_CARDS.map((card, i) => (
            <div key={i} className="flex flex-col gap-4">
              <div className="rounded-[13px] border border-[#E6E6E6] bg-[#FBFBFB]  shadow-[0_6px_10px_-6px_#00000016]  overflow-hidden p-2">
                <img
                  src={card.img}
                  alt={card.boldText}
    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-[#F7F7F7] border-b border-[#E6E6E6]">
      <div className="max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {FEATURES.map((f, i) => (
            <div key={i} className="flex flex-col gap-4">
              <div className="rounded-[13px] border border-[#E6E6E6] bg-white p-2 overflow-hidden  shadow-[0_6px_10px_-6px_#00000016] ">
                <img
                  src={f.img}
                  alt={f.text}
      ...
      <div className="max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-20">
        ...
        <div className="flex flex-col gap-4 max-w-4xl mx-auto">
          {FAQ_ITEMS.map((question, i) => (
            <div key={i} className="rounded-[13px] border border-[#E6E6E6] bg-[#FBFBFB]  shadow-[0_6px_10px_-6px_#00000016]  overflow-hidden transition-all duration-150">
              <button
