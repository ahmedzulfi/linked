        ...
        <div className="max-w-[1536px] mx-auto flex flex-col gap-16 relative z-10">
          ...
          <div className="relative rounded-[20px] bg-white/[0.01] border border-white/5 p-8 sm:p-10 lg:p-12 overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col gap-3 max-w-xl text-center lg:text-left z-10">
              <span className="text-emerald-400 font-semibold tracking-wider text-xs uppercase">Next Generation Portfolios</span>
              <h2 className="text-white text-3xl sm:text-4xl font-light tracking-tight leading-[1.15]">
                Ready to stand out? <br />
                <span className="font-semibold text-emerald-400">Convert your LinkedIn now.</span>
              </h2>
            ...
            <div className="w-full max-w-md flex flex-col sm:flex-row gap-3 z-10">
              <input
                ...
                className="flex-1 h-12 px-5 rounded-[13px] border border-white/10 bg-white/5 text-white placeholder:text-white/30 text-sm outline-none focus:border-emerald-500/50 focus:bg-white/[0.08] transition-all"
              />
              <button className="h-12 px-6 rounded-[13px] bg-emerald-500 hover:bg-emerald-400 text-white font-medium text-sm transition-all shadow-[0_4px_20px_rgba(16,185,129,0.25)] hover:shadow-[0_4px_25px_rgba(16,185,129,0.4)] flex items-center justify-center gap-2 whitespace-nowrap active:scale-95">
                Generate Page
                ...
                <div className="flex flex-col gap-3">
                  {navLinks.map((link) => (
                    <Link
                      key={link.label}
                      to={link.to}
                      className="text-white/60 hover:text-emerald-400 hover:translate-x-1.5 transition-all duration-300 text-[15px] font-normal inline-flex items-center"
                    >
                      {link.label}
                    </Link>
                  ))}
                ...
                <div className="flex flex-wrap sm:flex-col gap-2">
                  {socialLinks.map((link) => (
                    <a
                      key={link.label}
                      href={link.href}
                      className="px-4 py-2 rounded-[10px] border border-white/5 bg-white/[0.02] text-white/70 hover:text-white hover:bg-emerald-500 hover:border-emerald-400 transition-all duration-300 text-[14px] font-medium flex items-center justify-between group"
                    >
          ...
          <div className="relative pt-6 flex flex-col sm:flex-row items-center justify-between gap-6 z-10">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-[13px] bg-white/[0.03] border border-white/5 hover:border-emerald-500/30 text-white/60 hover:text-emerald-400 text-sm font-medium transition-all group"
            >
