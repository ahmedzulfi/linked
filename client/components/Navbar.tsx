    ...
    <nav className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-[1536px] px-6 sm:px-0">
      <div className="flex items-center justify-between h-14 px-2 pl-5 sm:pl-8 rounded-[13px] border border-[#F3F3F3] bg-[#FBFBFB] shadow-[0_6px_10px_-6px_rgba(0,0,0,0.09)]">
        ...
        <div className="hidden lg:flex items-center gap-6">
          <Link to="/" className="text-black/75 text-[15px] leading-[23px] hover:text-black transition-colors">Features</Link>
          <Link to="/" className="text-black/75 text-[16px] leading-[23px] hover:text-black transition-colors">FAQ</Link>
          <Link to="/" className="text-black/75 text-[15px] leading-[23px] hover:text-black transition-colors">Templates</Link>
          <Link to="/" className="text-black/75 text-[16px] leading-[23px] hover:text-black transition-colors">Pricing</Link>
          <Link to="/" className="text-black/75 text-[16px] leading-[23px] hover:text-black transition-colors">Docs</Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-2">
            {/* Discord */}
            <button className="flex items-center justify-center w-10 h-10 rounded-[13px] bg-[#F3F3F3] card-btn-shadow hover:bg-[#e8e8e8] transition-colors">
          ...
          {/* Log in */}
          <button className="hidden sm:flex h-10 px-6 items-center justify-center rounded-[13px] bg-[#F3F3F3] card-btn-shadow text-black text-[15px] hover:bg-[#e8e8e8] transition-colors whitespace-nowrap">
            Log in
          </button>

          {/* Get started */}
          <button className="flex h-10 px-5 sm:px-6 items-center justify-center rounded-[13px] btn-dark text-white text-[15px] whitespace-nowrap hover:opacity-90 transition-opacity">
            Get started
          </button>

          {/* Mobile menu button */}
          <button
            className="lg:hidden flex items-center justify-center w-10 h-10 rounded-[13px] bg-[#F3F3F3] ml-1"
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="mt-2 rounded-[13px] border border-[#F3F3F3] bg-[#FBFBFB] shadow-[0_6px_10px_-6px_rgba(0,0,0,0.09)] p-4 flex flex-col gap-3 lg:hidden">
          <Link to="/" className="text-black/75 text-[15px] py-2 hover:text-black transition-colors" onClick={() => setMobileOpen(false)}>Features</Link>
          <Link to="/" className="text-black/75 text-[15px] py-2 hover:text-black transition-colors" onClick={() => setMobileOpen(false)}>FAQ</Link>
          <Link to="/" className="text-black/75 text-[15px] py-2 hover:text-black transition-colors" onClick={() => setMobileOpen(false)}>Templates</Link>
          <Link to="/" className="text-black/75 text-[15px] py-2 hover:text-black transition-colors" onClick={() => setMobileOpen(false)}>Pricing</Link>
          <Link to="/" className="text-black/75 text-[15px] py-2 hover:text-black transition-colors" onClick={() => setMobileOpen(false)}>Docs</Link>
          <div className="flex items-center gap-2 pt-2 border-t border-[#F3F3F3]">
            <button className="flex-1 h-10 rounded-[13px] bg-[#F3F3F3] card-btn-shadow text-black text-[15px]">Log in</button>
            <button className="flex-1 h-10 rounded-[13px] btn-dark text-white text-[15px]">Get started</button>
          </div>
        </div>
      )}
    </nav>
