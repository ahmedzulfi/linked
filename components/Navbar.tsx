      ...
      <div className="flex items-center justify-between h-14 px-7 py-8 bg-white/70 backdrop-blur-md rounded-[13px] border border-[#E6E6E6] shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-2">
            {/* Discord */}
            <button className="flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#E6E6E6] shadow-sm text-black hover:bg-[#F3F3F3] active:scale-[0.95] transition-[transform,background-color] duration-150 ease-out">
          ...
          <button className="hidden sm:flex h-10 px-5 items-center justify-center rounded-[13px] bg-[#F3F3F3] text-black text-[12px] font-medium hover:bg-[#EAEAEA] active:scale-[0.97] transition-[transform,background-color] duration-150 ease-out whitespace-nowrap font-inter-tight">
            Log in
          </button>

          {/* Get started (Primary style) */}
          <button className="flex h-10 px-5 items-center justify-center rounded-[13px] btn-dark text-white text-[12px] font-medium whitespace-nowrap font-inter-tight">
            Get started
          </button>
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-[#E6E6E6]">
              <button className="flex-1 h-10 rounded-[13px] bg-[#F3F3F3] text-black text-[12px] font-medium hover:bg-[#EAEAEA] active:scale-[0.97] transition-[transform,background-color] duration-150 ease-out">Log in</button>
              <button className="flex-1 h-10 rounded-[13px] btn-dark text-white text-[12px] font-medium font-inter-tight">Get started</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
