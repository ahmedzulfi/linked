...
- **Landing Page Hero Layout (Minimalist Centered):** To avoid visual clutter, the hero is centered and consists strictly of the badge, display title, supporting copy, and side-by-side CTA buttons. The layout avoids complex grid containers or mockups in this section, allowing the beautiful organic landscape background image (`bg.png`) to remain fully visible.
