        ...
        <div className="w-full max-w-[140px] bg-white rounded-[8px] border border-[#E6E6E6] p-3  shadow-[0_6px_10px_-6px_#00000016] ">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="flex flex-col gap-1">
              <div className="h-1.5 w-14 bg-[#2A2A2F] rounded-full" />
              <div className="h-1 w-10 bg-[#E6E6E6] rounded-full" />
            </div>
          </div>
          ...
          <div className="flex gap-1">
            {[1, 2, 3].map(i => (
              <div key={i} className="h-3 px-2 rounded-full bg-[#DCEAFF] flex items-center">
    ...
    return (
      <div className="w-full h-full p-3 grid grid-cols-2 grid-rows-3 gap-1.5" style={{ backgroundColor: template.previewBg }}>
        <div className="col-span-2 bg-white rounded-[6px] border border-[#E6E6E6] p-2 flex items-center gap-2">
          <div className="w-5 h-5 rounded-full bg-[#E6E6E6] flex-shrink-0" />
          <div className="h-1.5 w-16 bg-[#2A2A2F] rounded-full" />
        </div>
        ...
        <div className="col-span-2 bg-white rounded-[6px] border border-[#E6E6E6] p-2 flex gap-1">
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="h-2 px-1.5 rounded-full bg-[#F3F3F3] flex-shrink-0">
    ...
    return (
      <div className="w-full h-full flex flex-col" style={{ backgroundColor: template.previewBg }}>
        <div className="h-12 bg-[#2A2A2F] flex items-end px-3 pb-2">
          <div className="w-8 h-8 rounded-full bg-[#E6E6E6] border-2 border-white -mb-4" />
        </div>
        <div className="flex-1 bg-white px-3 pt-5 flex flex-col gap-2">
          ...
          {[1, 2].map(i => (
            <div key={i} className="flex gap-2 items-start">
              <div className="w-3 h-3 rounded-full bg-[#8DB8FF] mt-0.5 flex-shrink-0" />
  ...
  return (
    <div className="w-full h-full p-3 flex flex-col gap-2" style={{ backgroundColor: template.previewBg }}>
      <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-full bg-[#2A2A2F] border border-[#333]" />
        <div className="flex flex-col gap-1">
          <div className="h-1.5 w-14 bg-white/80 rounded-full" />
      ...
      <div className="flex gap-1 mt-1">
        {[1, 2, 3].map(i => (
          <div key={i} className="h-3 px-2 rounded-full bg-[#8DB8FF]/20 flex items-center">
            ...
            >
              ...
              {isSelected && (
                <motion.div
                  ...
                  className="absolute top-2 right-2 w-5 h-5 rounded-full bg-[#2A2A2F] flex items-center justify-center"
                >
