...
>
  ...
  <noscript>
    <p>
      <strong>Video:</strong>{" "}
      <a href="https://www.youtube.com/watch?v=VIDEO_ID">VIDEO_TITLE</a> by
      CHANNEL_NAME. DESCRIPTION_EXCERPT
    </p>
  </noscript>
</figure>
```
...
_Video: [VIDEO_TITLE](https://www.youtube.com/watch?v=VIDEO_ID) by CHANNEL_NAME_
```
